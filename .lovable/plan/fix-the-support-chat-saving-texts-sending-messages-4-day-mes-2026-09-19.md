...
2. Open the Admin page, run the new self-check, and tell me what it reports if anything is still red
  (most likely the service key on Netlify).   and now here is support telegram user name [https://t.me/Chatrex56](https://t.me/Chatrex56)  if teh user tries sending message on teh support chat and it fails it will redirerect the user to teh telegram chat [https://t.me/Chatrex56](https://t.me/Chatrex56)