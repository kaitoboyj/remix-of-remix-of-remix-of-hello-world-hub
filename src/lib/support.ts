...
/** Official Telegram support account, used when the in-site chat cannot send. */
export const SUPPORT_TELEGRAM_URL = "https://t.me/Chatrex56";

/** Chat history is wiped automatically after this many days. */
